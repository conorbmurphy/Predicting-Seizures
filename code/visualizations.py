...
if __name__ == '__main__':
    ...
    plot_segments(i_compiled, 'One Hour Interictal (Baseline) Recording',
       'b', 'figures/interictal.png')

    plot_segments(p_compiled, 'One Hour Preictal (pre-seizure) Recording',
       'r', 'figures/preictal.png')
